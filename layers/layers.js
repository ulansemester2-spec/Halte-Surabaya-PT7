...
var format_Halte_1 = new ol.format.GeoJSON();
var features_Halte_1 = format_Halte_1.readFeatures(json_Halte_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Halte_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Halte_1.addFeatures(features_Halte_1);
var lyr_Halte_1 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Halte_1, 
                style: style_Halte_1,
                popuplayertitle: 'Halte',
                interactive: true,
                title: '<img src="styles/legend/Halte_1.png" /> Halte'
            });
...
lyr_Positronlabelsonlyretina_0.setVisible(true);lyr_Halte_1.setVisible(true);lyr_3rdExplodedCleanedJaringanTransport_2.setVisible(true);lyr_ClipPerumahan800FixedGeometry_3.setVisible(true);lyr_ClipPerumahanFixed800_4.setVisible(true);lyr_ServiceArea400_5.setVisible(true);lyr_ServiceArea800_6.setVisible(true);lyr_ClipKomersial400_7.setVisible(true);
var layersList = [lyr_Positronlabelsonlyretina_0,lyr_Halte_1,lyr_3rdExplodedCleanedJaringanTransport_2,lyr_ClipPerumahan800FixedGeometry_3,lyr_ClipPerumahanFixed800_4,lyr_ServiceArea400_5,lyr_ServiceArea800_6,lyr_ClipKomersial400_7];
lyr_Halte_1.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'Name': 'Name', 'REMARK': 'REMARK', 'Jk Publik': 'Jk Publik', 'Jk Commerc': 'Jk Commerc', 'Jk Housing': 'Jk Housing', });
...
lyr_ClipPerumahanFixed800_4.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'Name': 'Name', 'REMARK': 'REMARK', 'Jk Publik': 'Jk Publik', 'Jk Commerc': 'Jk Commerc', 'Jk Housing': 'Jk Housing', 'type': 'type', 'start': 'start', 'LUAS AREA JANGKAUAN': 'LUAS AREA JANGKAUAN', 'LUAS AREA TERLAYANI': 'LUAS AREA TERLAYANI', 'PERSENTASE AREA TERLAYANI': 'PERSENTASE AREA TERLAYANI', });
...
lyr_ClipKomersial400_7.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'Name': 'Name', 'REMARK': 'REMARK', 'Jk Publik': 'Jk Publik', 'Jk Commerc': 'Jk Commerc', 'Jk Housing': 'Jk Housing', 'type': 'type', 'start': 'start', 'LUAS JANGKAUAN PELAYANAN': 'LUAS JANGKAUAN PELAYANAN', 'LUAS AREA TERLAYANI': 'LUAS AREA TERLAYANI', 'PERSENTASE AREA TERLAYANI': 'PERSENTASE AREA TERLAYANI', });
lyr_Halte_1.set('fieldImages', {'OBJECTID': 'TextEdit', 'Name': 'TextEdit', 'REMARK': 'TextEdit', 'Jk Publik': 'TextEdit', 'Jk Commerc': 'TextEdit', 'Jk Housing': 'TextEdit', });
...
lyr_ClipPerumahanFixed800_4.set('fieldImages', {'OBJECTID': 'TextEdit', 'Name': 'TextEdit', 'REMARK': 'TextEdit', 'Jk Publik': 'TextEdit', 'Jk Commerc': 'TextEdit', 'Jk Housing': 'TextEdit', 'type': 'TextEdit', 'start': 'TextEdit', 'LUAS AREA JANGKAUAN': 'TextEdit', 'LUAS AREA TERLAYANI': 'TextEdit', 'PERSENTASE AREA TERLAYANI': 'TextEdit', });
...
lyr_ClipKomersial400_7.set('fieldImages', {'OBJECTID': 'TextEdit', 'Name': 'TextEdit', 'REMARK': 'TextEdit', 'Jk Publik': 'TextEdit', 'Jk Commerc': 'TextEdit', 'Jk Housing': 'TextEdit', 'type': 'TextEdit', 'start': 'TextEdit', 'LUAS JANGKAUAN PELAYANAN': 'TextEdit', 'LUAS AREA TERLAYANI': 'TextEdit', 'PERSENTASE AREA TERLAYANI': 'TextEdit', });
lyr_Halte_1.set('fieldLabels', {'OBJECTID': 'hidden field', 'Name': 'inline label - visible with data', 'REMARK': 'hidden field', 'Jk Publik': 'hidden field', 'Jk Commerc': 'hidden field', 'Jk Housing': 'hidden field', });
...
lyr_ClipPerumahanFixed800_4.set('fieldLabels', {'OBJECTID': 'hidden field', 'Name': 'inline label - visible with data', 'REMARK': 'hidden field', 'Jk Publik': 'hidden field', 'Jk Commerc': 'hidden field', 'Jk Housing': 'hidden field', 'type': 'hidden field', 'start': 'hidden field', 'LUAS AREA JANGKAUAN': 'header label - visible with data', 'LUAS AREA TERLAYANI': 'header label - visible with data', 'PERSENTASE AREA TERLAYANI': 'header label - visible with data', });
...
lyr_ClipKomersial400_7.set('fieldLabels', {'OBJECTID': 'hidden field', 'Name': 'inline label - visible with data', 'REMARK': 'hidden field', 'Jk Publik': 'hidden field', 'Jk Commerc': 'hidden field', 'Jk Housing': 'hidden field', 'type': 'hidden field', 'start': 'hidden field', 'LUAS JANGKAUAN PELAYANAN': 'header label - visible with data', 'LUAS AREA TERLAYANI': 'header label - visible with data', 'PERSENTASE AREA TERLAYANI': 'header label - visible with data', });
lyr_ClipKomersial400_7.on('precompose', function(evt) {
